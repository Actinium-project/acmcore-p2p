...
function builder(options) {
  ...
  if (!options.network) {
    options.network = acmcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || acmcore.Block;
  options.BlockHeader = options.BlockHeader || acmcore.BlockHeader;
  options.Transaction = options.Transaction || acmcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || acmcore.MerkleBlock;
